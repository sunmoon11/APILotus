        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-xs-2 modal_input_label">Hour</div>
                        <div class="col-xs-10" style="height:30px;">
                    ...
                    <div class="row">
                        <div class="col-xs-offset-2 col-xs-10" style="height:30px;">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    ...
                    <div class="row" style="margin-bottom:5px;">
                        <div class="col-xs-3 modal_input_label add_receiver_label">Receiver Name</div>
                        <div class="col-xs-9"><input type="text" class="form-control input-sm add_receiver_name"></div>
                    </div>
                    <div id="telegram_add_chatid" class="row" style="margin-bottom:5px;display:none">
                        <div class="col-xs-3 modal_input_label add_chatid_label">Chat ID</div>
                        <div class="col-xs-9"><input type="text" class="form-control input-sm add_receiver_chatid"></div>
                    </div>
                    <div class="row">
                        <div class="col-xs-9 col-xs-offset-3" style="height:30px;"><input type="checkbox" class="input-sm add_receiver_state" style="vertical-align:middle;margin:0;padding:0;">&nbsp;&nbsp;Disable Alert Receiver</input></div>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    ...
                    <div class="row" style="margin-bottom:5px;">
                        <div class="col-xs-3 modal_input_label edit_receiver_label">Receiver Name</div>
                        <div class="col-xs-9"><input type="text" class="form-control input-sm edit_receiver_name"></div>
                    </div>
                    <div id="telegram_edit_chatid" class="row" style="margin-bottom:5px;display:none">
                        <div class="col-xs-3 modal_input_label edit_chatid_label">Chat ID</div>
                        <div class="col-xs-9"><input type="text" class="form-control input-sm edit_receiver_chatid"></div>
                    </div>
                    <div class="row">
                        <div class="col-xs-9 col-xs-offset-3" style="height:30px;"><input type="checkbox" class="input-sm edit_receiver_state" style="vertical-align:middle;margin:0;padding:0;">&nbsp;&nbsp;Disable Alert Receiver</input></div>
                    </div>
                </div>
            </div>
            <div class="modal-footer">

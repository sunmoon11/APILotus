...
if ($crmInfo != null)
{
	...
	{
		$response = $kkcrmHook->getRetentionReport($token, $fromDate, $toDate, $cycles, $productID, $affiliateID);
		$response = $kkcrmHook->parseRetentionReport($response, $campaignIDs, $campaignNames);
